 ...
 */
@JRubyClass(name = "Rubylet::Rack::Hash")
public class Hash extends RubyHash {
    ...
    public static void create(Ruby runtime) {
        final RubyModule rack = runtime.defineModule("Rubylet").defineOrGetModuleUnder("Rack");
        final RubyModule hash = rack.defineClassUnder("Hash", runtime.getHash(), ALLOCATOR);
