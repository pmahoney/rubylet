 ...
 *
 */
@JRubyClass(name = "Rubylet::Rack::AsyncCallback")
public final class AsyncCallback extends RubyObject {
    ...
    public static void create(Ruby runtime) {
        ...
        final RubyModule rack = rubylet.defineModuleUnder("Rack");
        final RubyClass env = rack.defineClassUnder("AsyncCallback",
                                                    runtime.getObject(),
        ...
        runtime.evalScriptlet("Rubylet::ASYNC_COMPLETE = " +
